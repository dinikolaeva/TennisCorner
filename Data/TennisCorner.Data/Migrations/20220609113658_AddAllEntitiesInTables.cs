...
{
    public partial class AddAllEntitiesInTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryAbbreviation = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Age = table.Column<int>(type: "int", nullable: false, computedColumnSql: "DATEDIFF(yy, DateOfBirth, GETDATE()) - CASE WHEN (MONTH(DateOfBirth) >= MONTH(GETDATE()))  AND DAY(DateOfBirth) > DAY(GETDATE()) THEN 1 ELSE 0 END"),
                    Height = table.Column<int>(type: "int", nullable: true),
                    Weight = table.Column<int>(type: "int", nullable: true),
                    CareerWin = table.Column<int>(type: "int", nullable: false),
                    CareerLoss = table.Column<int>(type: "int", nullable: false),
                    ...
                    TotalPrizeMoney = table.Column<double>(type: "float", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TournamentsPlayers", x => new { x.TournamentId, x.PlayerId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayingCategories_IsDeleted",
                table: "PlayingCategories",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Surfaces_IsDeleted",
                table: "Surfaces",
                column: "IsDeleted");
